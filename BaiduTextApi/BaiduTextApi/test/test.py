...
from BaiduTextApi.bin.carInfo.car_info import CarInfo  # 车牌号识别
...
if __name__ == '__main__':
    ...
    CPH = 'timg.jpg'  # 车牌号
    CPH = 'lspz.jpg'  # 车牌号
    car_info = 'QQ截图20190413194724.jpg'  # 汽车信息
    JDCXSFP = 'JDCXSFP.png'  # 机动车销售发票
    NUMBERS = 'NUMBERS.jpg'  # 数字
    url = 'https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1555163630335&di=c7fd065b471dff45151eec63f4d35157&imgtype=0&src=http%3A%2F%2Fimg.mp.itc.cn%2Fupload%2F20161014%2Fbaf2ba65400947c9978e11def7cd3070_th.jpg'  # 网络图片
    ...
    # 车牌号识别
    print (CPH)
    testLicensePlate = LicensePlate(image=car_info)
    print('车牌号识别：', testLicensePlate.postLicensePlate())

    testCarInfo = CarInfo(image=car_info)

    print('车辆信息：', testCarInfo.post_car_info())
